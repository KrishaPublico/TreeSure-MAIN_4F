        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(title, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: _darkGreen)),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const Text('Tree Inventory - PLTP',
      ...
      children: [
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text('Scan tree QR codes to auto-fill data', style: TextStyle(fontSize: 14, color: Colors.grey[600])),
                  const SizedBox(height: 32),
                  _buildGradientButton('Start Scanning', Icons.qr_code_scanner_rounded, onPressed: _startScanning),
                ],
              ),
            ),
          ),
        if (isScanning)
          Padding(
            ...
            child: SizedBox(
              width: double.infinity,
              child: _buildGradientButton('Stop Scanning', Icons.stop_rounded,
                  onPressed: _stopScanning, colors: [Colors.red[700]!, Colors.red[500]!]),
            ),
          ),
        if (scannedData != null)
          Container(
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.check_circle_rounded, color: _primaryGreen, size: 20),
                    ),
                    const SizedBox(width: 10),
                    const Text('Scanned Tree Data', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: _darkGreen)),
                  ],
                ),
                const SizedBox(height: 12),
                Container(
                  ...
                  padding: const EdgeInsets.all(12),
                  decoration: BoxDecoration(color: _surfaceColor, borderRadius: BorderRadius.circular(12)),
                  child: Text(scannedData!, style: const TextStyle(fontSize: 14)),
                ),
                const SizedBox(height: 16),
                _buildGradientButton('Use This Data', Icons.check_rounded, onPressed: () {
                  _stopScanning();
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Tree data loaded. Adjust if needed and submit.')),
                  );
                }),
              ],
            ),
  ...
  Widget _buildRegisterTab() {
    return ListView(
      ...
      children: [
        ...
        Container(
          ...
          child: DropdownButtonFormField<String>(
            ...
            items: const [
              ...
              DropdownMenuItem(value: 'Not Yet Ready', child: Text('Not Yet Ready')),
            ],
        ...
        const SizedBox(height: 12),
        _buildGradientButton('Tree Tagging Completed', Icons.flag_rounded,
            onPressed: _completeTreeTagging, colors: [Colors.orange[700]!, Colors.orange[500]!]),
        const SizedBox(height: 20),
      ],
    );
  }
