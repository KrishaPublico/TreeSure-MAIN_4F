...
class ApplicantQr extends StatefulWidget {
  const ApplicantQr({super.key});

  @override
  State<ApplicantQr> createState() => _QrUploadScannerState();
}

class _QrUploadScannerState extends State<ApplicantQr> {
  String? scannedData;
